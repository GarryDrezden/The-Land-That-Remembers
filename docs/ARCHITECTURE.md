...
| House runtime | `…/yard_vs01/main_house_v1.png` — key BG, eave seal, binary alpha, nearest ÷4 × **0.88** (245×128) |
| Start camera | zoom **1.4**, offset `(0,-40)`, spawn front yard; map 40×34 tiles |
